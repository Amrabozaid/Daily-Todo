...
import 'package:flutter_project/widgets/add_small_todos_bottom_sheet.dart';
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: SmallTodoWidget(
                                        smallTodo: smallTodo,
                                        onDelete: (){setState(() {expansionPanelController.deleteSmallTodo(panel.header, smallTodo.title);});},
                                        onToggleCompleted: () { setState(() {expansionPanelController.toggleTodoCompletion(panel.header, smallTodo.title);});},
                                        onUpdate: (oldTitle, newTitle) {setState(() {expansionPanelController.updateSmallTodo(panel.header, oldTitle, newTitle);});}
                                      )
                                    ),
                                  ),
                                ],
